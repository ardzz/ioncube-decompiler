...
The handler contract: ``Handler = Callable[[LiftContext, int, int], int]`` —
run the node at index ``i`` inside region end ``end`` and return the
...
more machinery, zero behavior gain.)
"""
